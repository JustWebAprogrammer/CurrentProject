...
try {
    ...
    //Verificar se aceitou o TdU
    $accept_terms = isset($_POST['accept_terms']) ? $_POST['accept_terms'] : '';
if (empty($accept_terms)) {
    throw new Exception("Você deve aceitar os Termos de Uso e Política de Privacidade");
}
    ...
    if ($cliente->criar()) {
        ...
        // Usar o sistema unificado de autenticação
        AuthUnified::logarUsuario($clienteData, 'Cliente');
